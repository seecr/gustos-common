...
#
# Copyright (C) 2013-2014, 2018 Seecr (Seek You Too B.V.) https://seecr.nl
#
...
from gustos.common import digest

class DigestTest(TestCase):
    def testShouldGiveADigestWithASharedSecret(self):
        self.assertEqual('9847b80aaf97ece67ad01215cd092000bba8dad4', digest(clientIdentifier=''))
        self.assertEqual('300fb9820983148278350709f0424855a83a5862', digest('some-client-id'))
